...
exports.run = (client, message, params, randomColor,Discord) => {
  ...
  if (message.author) embed.addField ("Offense", atkVulnDisplay.join ("\n\n"));
  embed.addField("Defense", vulnDisplay.join ("\n\n"));
  if (message.pic) embed.setImage (message.pic);
...
exports.help = {
  name: 'type',
  description: 'Shows info on a Pokemom type.',
