...
const {writeFile} = require("fs");
   ...
   const filtered =  client.shiny.filterArray( p => p.points > 0 ); 
                                           const sorted =  filtered.sort(
                  
(a, b) => b.points-a. points) // console. log(a))//a.shiny<b.shiny);//.((a) console.log(b) *//a. < b.); 
                                          //console.log(sorted);
...
exports.help = {
  name: 'shinyleaderboard', 
  description: 'see TOP 10 Shinyhunters.',
  usage: 'slb <>', 
  module: 'Gambling', 
  permit: ' ', 
  alias: ' '
