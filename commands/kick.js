...
  if (!member.kickable) return message.channel.send(/*`You cant kick *//*`**${member.user.user*/`❌  I can't do that because I'm missing the **Kick Members** permission. Fix my perms to resolve the issue.\nOr , make my role higher than the person whom you want to kick!!`);
 ///*name}**`);
