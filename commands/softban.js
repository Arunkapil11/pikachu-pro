...
  if (!member.kickable || !member.bannable) return message.channel.send(`:x:  I can't do that because I'm missing the **Ban Members** permission. Fix my perms to resolve the issue.
Or , make my role higher than the person whom you want to kick!!`);//(`You cant soft ban **${member.user.username}**.`);
